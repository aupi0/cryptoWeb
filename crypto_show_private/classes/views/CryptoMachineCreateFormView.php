<?php
/**CryptoMachineCreateFormView.php
 *
 * Created by PhpStorm.
 * @author - Sam, Matt, Chris and Roan
 */

class CryptoMachineCreateFormView extends WebPageTemplateView
{
...
<p>Image name: <input type="text" name="crypto_machine_image_name" value="" size="20" maxlength="20" placeholder="Name of image" required="required" /></p>
...
<p><button name="feature" value="crypto_machine_create_process">Create Crypto Details</button></p>
</fieldset>
</form>
HTMLFORM;
	}
