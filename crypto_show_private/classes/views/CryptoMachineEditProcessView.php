<?php
/** CryptoMachineEditProcessView.php
 *
 * Created by PhpStorm.
 * @author - Sam, Matt, Chris and Roan
 */

class CryptoMachineEditProcessView extends WebPageTemplateView
{
private $store_new_crypto_machine_details_results;
    ...
    public function getUpdateCryptoMachineDetailsResult($store_new_crypto_machine_details_results)
    {
    ...
    {
        $this->page_title = APP_NAME . ' Update the details of your Crypto device';
    }
    ...
    {
        $page_heading = 'Update the details of your Crypto device';
...
<p><button name="feature" value="crypto_machine_edit" /><img src="$path_to_image" alt="Sad face" /><br />Try again</button></p>
</form>
HTMLOUTPUT;
        return $page_content;
    }
    ...
    private function create_success_message()
    {
        ...
        $page_content = <<< HTMLOUTPUT
<p>You have been successfully edited the details of your crypto machine.</p>
<p><button name="feature" value="crypto_machine_edit" /><img src="$path_to_image" alt="Happy face" /></button></p>
HTMLOUTPUT;
        return $page_content;
    }
}